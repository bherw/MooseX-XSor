...

{
	...
	my $e = exception { $meta->make_immutable };
	is($e, undef, "Foo is imutable");
...
my $e = exception { Bar->meta->make_immutable };
is($e, undef, 'Immutable meta with single BUILD');

$e = exception { Baz->meta->make_immutable };
is($e, undef, 'Immutable meta with multiple BUILDs');
